<?php 
   ...
   */
	...
	*/
     ...
     $result=mysql_query("SELECT username,password,uploadpath FROM users WHERE uploadpath!=''");
     while ($userData=mysql_fetch_object($result)){
     	$users[]=array($userData->username,sha1($userData->password),$basedir.$userData->uploadpath,"true","true");
     }
