...
if (defined('_VALID_TWG')) {
    ...
    $folder = '../upload_pics/'.$_SESSION['folder'];                  // this is the root upload folder. If you use login='auth' by default the folder from the user profile in .htusers.php is used!
    ...
    $upload_notification_email = 'winkelnkemper@googlemail.com';     // you can get an email everytime a fileupload was initiated! The mail is sent at the first file of an upload queue! '' = no emails - php mail has to be configured properly!
    ...
    $normalise_file_names = true;        // new 2.7.5 - This setting convertes all filenames to lowercase and special characters are removed e.g. !"#$%&'()*+,-- []\^_`Ã¶Ã¤Ã¼Ã are replaces with an _
    $normalise_directory_names = true;   // new 2.8.1 - This setting convertes all directory names that are created or renamed to lowercase and special characters are removed e.g. !"#$%&'()*+,-- []\^_`Ã¶Ã¤Ã¼Ã are replaces with an _
