...
$folder=mysql_query("SELECT folder,subfolder FROM files WHERE $userQuery AND `key`='$key'");
...
$images=mysql_query("SELECT `key`,subfolder FROM files WHERE $userQuery AND `folder`='$folder' ORDER BY sortstring");
