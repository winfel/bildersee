...
$tfu_config_version = '3.2';
    ...
    $upload_notification_email = 'winkelnkemper@googlemail.com';     // you can get an email everytime a fileupload was initiated! The mail is sent at the first file of an upload queue! '' = no emails - php mail has to be configured properly! Enter the e-mail you want to send the notification to. Also set the from address!
    ...
    // New 2.17
    $normalize_upper_case=false;          // New 2.17 (true,false) if you enable normalize file names or directory names you can decide here if upper case chars are converted to lower case or not.
    ...
    $change_to_new_folder=true;           // (true, false) If you create a new folder you can decide if you jump into the now folder (true) or if you stay in the parent folder (false)
     // new 3.1.1
